...
\setlength {\textheight}{8.75in}\setlength {\textwidth}{7.0in}\setlength {\footheight}{0.0in}\setlength {\topmargin}{0.25in}\setlength {\headheight}{0.0in}\setlength {\headsep}{0.0in}\setlength {\oddsidemargin}{-.35in}\setlength {\parskip}{1ex plus .2ex minus .2ex}\setlength {\parindent}{0pc}\setcounter {topnumber}{5}\setcounter {dbltopnumber}{5}
%
\providecommand{\GpC}[1]{{\bf GpC: #1 \\}}%
\providecommand{\StQ}[1]{{\bf StQ: #1 \\}}
\title{\Large\bf PdTRAV \\
...
$\textstyle \parbox{1.5in}{<DIV ALIGN="CENTER">
               Gianpiero Cabodi
...
$\textstyle \parbox{3in}{<DIV ALIGN="CENTER">
             Politecnico di Torino 
\\
             Dip. di Automatica e Informatica 
\\
