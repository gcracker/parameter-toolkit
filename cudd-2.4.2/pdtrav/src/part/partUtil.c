  ...
  )
{
  ...
  if (strcmp (string, "estimate")==0 || strcmp (string, "3")==0) {
     return (Part_MethodEstimate_c);
  }

  if (strcmp (string, "complex")==0 || strcmp (string, "4")==0) {
     return (Part_MethodEstimateComplex_c);
  }

  if (strcmp (string, "fast")==0 || strcmp (string, "5")==0) {
     return (Part_MethodEstimateFast_c);
  }

  if (strcmp (string, "free")==0 || strcmp (string, "6")==0) {
     return (Part_MethodEstimateFreeOrder_c);
  }

  if (strcmp (string, "comparison")==0 || strcmp (string, "7")==0) {
     return (Part_MethodComparison_c);
  }

  if (strcmp (string, "cuddAppCon")==0 || strcmp (string, "8")==0) {
     return (Part_MethodAppCon_c);
  }

  if (strcmp (string, "cuddAppDis")==0 || strcmp (string, "9")==0) {
     return (Part_MethodAppDis_c);
  }

  if (strcmp (string, "cuddGenCon")==0 || strcmp (string, "10")==0) {
  ...
  if (strcmp (string, "cuddIteCon")==0 || strcmp (string, "12")==0) {
     return (Part_MethodIteCon_c);
  }

  if (strcmp (string, "cuddIteDis")==0 || strcmp (string, "13")==0) {
     return (Part_MethodIteDis_c);
  }

  if (strcmp (string, "cuddVarCon")==0 || strcmp (string, "14")==0) {
     return (Part_MethodVarCon_c);
  }

  if (strcmp (string, "cuddVarDis")==0 || strcmp (string, "15")==0) {
