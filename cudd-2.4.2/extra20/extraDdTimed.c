...
typedef struct HashEntry_t
{
    ...
    uintptr_t Arg3;      // the second argument
} HashEntry;
...
//      return ( Cudd_NotCond( res, F != f ) );
    ...
    if ( HTable[HKey].Sign == s_Signature && HTable[HKey].Arg1 == (uintptr_t)F )
    {
...
//  }
    ...
    HTable[HKey].Arg1 = (uintptr_t)F;
    HTable[HKey].Arg2 = (uintptr_t)res;  
