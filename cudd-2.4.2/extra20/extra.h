...
(((uintptr_t)(a) + (uintptr_t)(b) * DD_P1) % TSIZE)

#define hashKey3(a,b,c,TSIZE) \
(((((uintptr_t)(a) + (uintptr_t)(b)) * DD_P1 + (uintptr_t)(c)) * DD_P2 ) % TSIZE)

#define hashKey4(a,b,c,d,TSIZE) \
((((((uintptr_t)(a) + (uintptr_t)(b)) * DD_P1 + (uintptr_t)(c)) * DD_P2 + \
   (uintptr_t)(d)) * DD_P3) % TSIZE)

#define hashKey5(a,b,c,d,e,TSIZE) \
(((((((uintptr_t)(a) + (uintptr_t)(b)) * DD_P1 + (uintptr_t)(c)) * DD_P2 + \
   (uintptr_t)(d)) * DD_P3 + (uintptr_t)(e)) * DD_P1) % TSIZE)


// complementation and testing for pointers for hash entries
#define Hash_IsComplement(p)  ((int)((uintptr_t) (p) & 02))
#define Hash_Regular(p)       ((DdNode*)((uintptr_t)(p) & ~02))
#define Hash_Not(p)           ((DdNode*)((uintptr_t)(p) ^ 02))
#define Hash_NotCond(p,c)     ((DdNode*)((uintptr_t)(p) ^ (02*c)))
...
/* decomposition of the function into a set of functions that have Hamming distance > 1. */
...
extern DdNode * extraZddIsopCoverRandom( DdManager * dd,  DdHashTable * table,  DdNode * bA,
					 DdNode * bB, int * permut, int  cVar );
...
extern int * mg_Extra_zddLitCount( DdManager * dd, DdNode * Set, const int maxDepth );
...
/* swaps the variables in a ZDD */
extern DdNode *    mg_Extra_zddSwapVariables(DdManager * dd, DdNode * f, 
