/**CHeaderFile*****************************************************************
  ...
  Synopsis     [Functions to read in and write out BDDs, ADDs, ZDDs 
...
/**Struct************************************************************************
  ...
  Synopsis    [Holds additional information to be saved off with the BDD.]

  Description [ This struct allows easier future expansion of future information
                that can be saved off into the DD header
    ]
...
extern DdNode * Dddmp_cuddZddLoad(DdManager *ddMgr, Dddmp_VarMatchType varMatchMode, char **varmatchnames, int *varmatchauxids, int *varcomposeids, int mode, char ** extrainfo, char *file, FILE *fp);
extern int Dddmp_cuddZddArrayLoad(DdManager *ddMgr, Dddmp_RootMatchType rootMatchMode, char **rootmatchnames, Dddmp_VarMatchType varMatchMode, char **varmatchnames, int *varmatchauxids, int *varcomposeids, int mode, char ** extrainfo, char *file, FILE *fp, DdNode ***pproots);
extern DdNode * Dddmp_cuddBddLoad(DdManager *ddMgr, Dddmp_VarMatchType varMatchMode, char **varmatchnames, int *varmatchauxids, int *varcomposeids, int mode, char ** extrainfo, char *file, FILE *fp);
extern int Dddmp_cuddBddArrayLoad(DdManager *ddMgr, Dddmp_RootMatchType rootMatchMode, char **rootmatchnames, Dddmp_VarMatchType varMatchMode, char **varmatchnames, int *varmatchauxids, int *varcomposeids, int mode, char ** extrainfo, char *file, FILE *fp, DdNode ***pproots);
extern DdNode * Dddmp_cuddAddLoad(DdManager *ddMgr, Dddmp_VarMatchType varMatchMode, char **varmatchnames, int *varmatchauxids, int *varcomposeids, int mode, char ** extrainfo, char *file, FILE *fp);
extern int Dddmp_cuddAddArrayLoad(DdManager *ddMgr, Dddmp_RootMatchType rootMatchMode, char **rootmatchnames, Dddmp_VarMatchType varMatchMode, char **varmatchnames, int *varmatchauxids, int *varcomposeids, int mode, char ** extrainfo, char *file, FILE *fp, DdNode ***pproots);
...
extern int Dddmp_cuddZddStore(DdManager *ddMgr, char *ddname, DdNode *f, char **varnames, int *auxids, int mode, Dddmp_VarInfoType varinfo,  Dddmp_MoreDDHeaderInfo * extraInfo,char *fname, FILE *fp);
extern int Dddmp_cuddZddArrayStore(DdManager *ddMgr, char *ddname, int nRoots, DdNode **f, char **rootnames, char **varnames, int *auxids, int mode, Dddmp_VarInfoType varinfo, Dddmp_MoreDDHeaderInfo * extraInfo, char *fname, FILE *fp);
extern int DddmpCuddZddArrayStore (Dddmp_DecompType ddType, DdManager *ddMgr, char *ddname, int nRoots, DdNode **f, char **rootnames, char **varnames, int *auxids, int mode, Dddmp_VarInfoType varinfo, Dddmp_MoreDDHeaderInfo * extraInfo, char *fname, FILE *fp );
...
extern int Dddmp_cuddBddStore(DdManager *ddMgr, char *ddname, DdNode *f, char **varnames, int *auxids, int mode, Dddmp_VarInfoType varinfo,  Dddmp_MoreDDHeaderInfo * extraInfo,char *fname, FILE *fp);
extern int Dddmp_cuddBddArrayStore(DdManager *ddMgr, char *ddname, int nRoots, DdNode **f, char **rootnames, char **varnames, int *auxids, int mode, Dddmp_VarInfoType varinfo, Dddmp_MoreDDHeaderInfo * extraInfo, char *fname, FILE *fp);
...
extern Dddmp_DecompType DddmpDdReadType (char *file, FILE *fp );
